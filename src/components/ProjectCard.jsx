...
export default function ProjectCard({ title, description, image, tech, icons, demo, code }) {
    return (
        <div className='flex flex-col min-w-[320px] max-w-[320px] flex-shrink-0 rounded-2xl bg-dark-100 p-6 transition-transform duration-300 hover:scale-105'>
            <img src={image} alt="image-not-loaded" className='rounded-2xl w-full h-[250px] ' />
            ...
            <div className='flex md:flex-row items-center gap-2 flex-wrap rounded-2xl px-3 py-1 text-sm'>
            ...
            <div id='code' className=' flex justify-center items-center mt-auto'>
